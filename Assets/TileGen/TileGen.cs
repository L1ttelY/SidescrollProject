...
public class SpriteProcessor:AssetPostprocessor {
	...
	public void OnPostprocessTexture(Texture2D texture) {
		...
		if(!assetPath.Contains("itspkr")) return;
...
public class TileGen:MonoBehaviour {
	...
	[SerializeField] string ruleTileType;
	...
	public void CreateRuleTile() {
		...
		RuleTile rTile = ScriptableObject.CreateInstance(ruleTileType) as RuleTile;

		if(!rTile) {
			Debug.LogError("Cannot find rule tile type "+ruleTileType);
			return;
		}
